...
namespace Monosoft.ServiceStore.Service.MessageHandlers
{
    using System;
    ...
    public class CallContext
    {
        ...
        public CallContext(Guid organisation, Token token, DateTime issueDate)
        {
            ...
            {
                this.IsServiceStoreAdmin = MemoryCache.Instance.HasClaim(token, organisation, ClaimDefinitions.ServiceStoreAdmin, issueDate);
            }
            else
            {
                this.IsServiceStoreAdmin = false;
            }
        }
        ...
        /// </summary>
        public bool IsServiceStoreAdmin { get; set; }
